...
namespace Tenolo\Bundle\FormOrderedBundle\Tests\DependencyInjection;

use Tenolo\FormOrdererd\Extension\OrderedButtonExtension;
use Tenolo\FormOrdererd\Extension\OrderedFormExtension;
use Tenolo\FormOrdererd\OrderedResolvedFormTypeFactory;
use Tenolo\FormOrdererd\DependencyInjection\IvoryOrderedFormExtension;
 ...
 */
class TenoloFormOrdererdExtensionTest extends \PHPUnit_Framework_TestCase
{
    /**
